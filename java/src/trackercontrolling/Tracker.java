/* A Tracker instance represents a laser tracker (there is probably
 * only one, but whatever). It allows client code to send various
 * commands to the tracker and receive measurements from it.
...
public class Tracker {
    ...
    public static class UnconnectedException extends RuntimeException {}
